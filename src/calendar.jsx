...
const isDropdownSelect = (element = {}) => {
  ...
  return DROPDOWN_FOCUS_CLASSNAMES.some(testClassname => classNames.includes(testClassname))
}
...
class Calendar extends Component {
  ...
  renderMonths() {
    ...
    for (let i = 0; i < this.props.monthsShown; ++i) {
      const monthDate = this.state.date.clone().add(i, 'M')
      ...
      monthList.push(
        <div key={monthKey} className="react-datepicker__month-container">
          <div className="react-datepicker__header">
            ...
            <div className={`react-datepicker__header__dropdown react-datepicker__header__dropdown--${this.props.dropdownMode}`}
  ...
  renderNextMonthButton() {
    ...
    return <a className="react-datepicker__navigation react-datepicker__navigation--next"
  ...
  renderPreviousMonthButton() {
    ...
    return <a className="react-datepicker__navigation react-datepicker__navigation--previous"
